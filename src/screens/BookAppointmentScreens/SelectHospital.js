...
import { GetOptimalHieght, GetOptimalWidth, scaledFontSize } from '../../helpers/commonHelpers/helpers';

const data = [
    {
        id: 0,
        name: "Umar Hospital",
        image: "https://lh5.googleusercontent.com/p/AF1QipMaANAWXvBt8hZ7mw_nfH3lTA4Cd0eAYZER8DWv=w1080-k-no",
...
export default class HospitalListing extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    renderItem = ({ item }) => {
        return <TouchableOpacity
            onPress={() => { this.props.navigation.navigate("HospitalDetail", { data: item }) }}
            style={{
                flexDirection: 'row',
        ...
        >
            ...
            <View style={{
                ...
                <Image source={images.dots} style={{
    ...
    render() {
        ...
        return (
            <View style={{
                ...
                onMenuPress={() => { this.props.navigation.goBack(); }} onBellPress={() => { alert("bell") }} />
                <View
                    style={{
                        flexDirection: 'row',
                        justifyContent: "center",
